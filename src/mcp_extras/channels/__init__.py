...
.. deprecated::
    Use :mod:`mcp_extras.engines` and
    :mod:`mcp_extras.transports` directly. These channel classes are
    retained only for backward compatibility.

For new code prefer::

    from mcp_extras.engines import ApprovalEngine, WhatsAppEngine
